    ...
    <head>
        ...
        <SCRIPT>
            function outputList(ar, size) {
                ...
                str += "SIZE=\"" + size + "\" NAME=\"notifList\" STYLE=\"width: 250pt\">"
            ...
            <tr>
                ...
                <td>
                    <FORM METHOD=post ONSUBMIT="processForm(this)">
                        <table class="tableForm" cellpadding=2 cellspacing=2>
                            <tr>
                                    ...
                                    <tr>
                                        <td valign="top" width="100%" class="oddcol">
                                            <table cellspacing=2 cellpadding=2>
                                                    <tr>
                                                        <td valign="top" width="75%" halign="right" cellspacing=5 cellpadding=5>
                                                            <SCRIPT>
