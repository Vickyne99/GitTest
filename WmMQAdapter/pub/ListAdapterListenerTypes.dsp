...
<html>
    ...
    <input type="hidden" name="searchListenerName" value="%value searchListenerName%">
        <table class="tableView" width="100%">
            ...
            <tr>
                <td style="border-right: none; border-left: none" colspan=2>
                    <ul>
                        <li>
                        	<!-- ION -->
                    ...
                    %loop listenerTypes%
                        <tr>
                            <script>writeTD('rowdata-l');</script>
                                <a href="/WmMQAdapter/SetListenerProperties.dsp?adapterTypeName=%value -urlencode adapterTypeName%&listenerTypeName=%value -urlencode listenerTypeName%">%value listenerDisplay%</a>
                            </td>
