...
<HTML>
    ...
    <BODY onLoad="setNavigation('ListResources.dsp', '%value -urlencode helpsys%', 'foo');">
		<!-- ION -->
...
<table class="tableView" width="100%">
        ...
        %ifvar mgdConnTypes%
            ...
            <!-- ION -->
            <a href="/WmMQAdapter/GetConnProperties.dsp?adapterTypeName=%value -urlencode adapterTypeName%&connectionFactoryType=%value -urlencode connectionFactoryType%&searchConnectionName=%value -urlencode ../searchConnectionName%">%value mgdConnFactoryDisplay%</a></td>
