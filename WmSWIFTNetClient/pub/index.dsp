...
<SCRIPT SRC="webMethods.js.txt"></SCRIPT>
 ...
 %ifvar saveMessage equals('infoSaved')%
    %invoke wm.swiftnet.client.util:saveConfigInfo%
    %endinvoke%
  %endif%
...
%ifvar saveMessage equals('infoSaved')%
<TD class="heading" colspan="2">SWIFTNet Client configuration information has been saved successfully. Please reload the package to apply changes</TD>
%endif%
          		...
          		<tr>
              		...
              		<tr>
						  ...
						  <td class="oddrowdata-l">%value RMIPort%</td>
			                  		 ...
			                  		 <TR>
			    			            <TD class="heading" colspan="2">SWIFTNet Client SAG Connection Information </TD>
			              		</TR> 
			              		<tr>
			                  		...
			                  		<tr>
			    						   <td class="oddrow">client_pki_profile</td>
			    						  <td class="oddrowdata-l">%value client_pki_profile%</td>
			                  		</tr>
			                  		<tr>
			    						   <td class="oddrow">client_pki_password</td>
							...
							<tr>
			                  		...
			                  		<tr>
			    						   <td class="oddrow">requestor</td>
			    						  <td class="oddrowdata-l">%value requestor%</td>
			                  		</tr>
			    
			                  		<tr>
			    						   <td class="oddrow">responder</td>
			    						  <td class="oddrowdata-l">%value responder%</td>
			                  		</tr>
			                  		...
			                  		<tr>
			    						  ...
			    						  <td class="oddrowdata-l">%value userDN%</td>
			                  		</tr>
			                  		<tr>
									...
									<tr>
			    						   <td class="oddrow">physicalName</td>
			    						  <td class="oddrowdata-l">%value physicalName%</td>
			                  		</tr>
									
									<tr>
			    						   <td class="oddrow">logicalName</td>
			    						  <td class="oddrowdata-l">%value logicalName%</td>
			                  		</tr>
