<TABLE WIDTH=100%>
<TR CLASS="title">
  <TH>Transaction Import Files</TH>
</TR>
%invoke wm.estd.chemical.impt:listParFiles%
%ifvar -notempty files%
<FORM NAME="pipList" ACTION="chem-import.dsp" METHOD="POST">
%loop files%
<TR>
  <TD CLASS="rowdata">
...
<TR>
  ...
  a Transaction, an importable archive file must be downloaded from the product
