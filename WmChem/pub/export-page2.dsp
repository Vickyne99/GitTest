...
%endloop%
	<br>Test page <br>
%endcomment%
<FORM ACTION="chem-export.dsp" METHOD="POST">
	%ifvar nsNameList -notempty%
		...
		<TABLE WIDTH="75%">
			%invoke wm.estd.chemical.expt:getPipRecords%
				...
				%invoke wm.estd.chemical.expt:extractFromArray%
					%loop NewList%
						<TR>
						...
						%loop contents%
							<TR> 
								<!--
								<TH COLSPAN="2" CLASS="subheading">Record Name</TH>
								-->
							...
							<TR> 
								...
								%comment%
										...
										<INPUT TYPE="radio" CHECKED name="" value="No" >No
									%endcomment%
								</TD>
							</tr>
							<TR>
