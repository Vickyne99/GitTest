...
<tbody>
        ...
        <TR><Td class="heading" colspan=2>Oracle Applications Transaction Export</Td></TR>
...
%invoke wm.adapter.wmoa.exchange:supportedOAReleases%
    %ifvar releases%
                <TR><Td class="evenrowdata-l" width="28%">Oracle Apps Release</Td>
    ...
    %ifvar oarelease%
        ...
        %else%
            ...
            %endcomment%
            <TR>
               <Td class="evenrowdata-l" width=28%>Export File</Td>
               <TD class="evenrowdata-l">
            ...
            <TR>
               <Td class="evenrowdata-l" width=28%>Create Host</Td>
               <TD class="evenrowdata-l"><INPUT TYPE="TEXT" name="serverName" value="%value serverName%"></TD>
            </TR>
            <TR>
               <Td class="evenrowdata-l" width=28%>Description</Td>
               <TD class="evenrowdata-l"><INPUT TYPE="TEXT" name="description" MAXLENGTH="100"></TD>
            </TR>
            <TR>
               <TD class="action" colspan=2><CENTER>
            ...
            <TABLE class="tableView" WIDTH=100%>
            <TR >
                <Td class="heading" colspan=4>Choose Transactions to Export</Td>
            </TR>
            <TR class="subheading">
            	<Td width=22%>Export this transaction <BR>
            ...
            %ifvar NO_TRANS%
                <TR>
                    <Td  class="evenrowdata-l" id="message" colspan=3>No transactions found for export.</Td>
                </TR>
            %else%
    ...
    %else%
        ...
        <TR>
           <TD class="evenrowdata-l" colspan=2>
    	    <INPUT type="button" value="Cancel" 
                onclick="document.location='oa-transmgmt.dsp';" ></input>
           </TD>
        </TR>
    %endif%
