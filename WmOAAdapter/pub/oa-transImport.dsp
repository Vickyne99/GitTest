...
<TD>
    <TABLE class="tableView" WIDTH=100%>
        ...
        <TR><Td class="heading" colspan=2>Oracle Applications Transaction Import</Td></TR>
...
%invoke  wm.adapter.wmoa.exchange:getImportFiles%
        <TR><Td class="evenrowdata-l" width="28%">Import Files</td>
...
%endif%
            <TR>
               <td class="evenrowdata-l" width=28%>Create From Server</td>
               <TD class="evenrowdata-l">%value exportInfo/CREATE_HOST%</TD>
            </TR>
            <TR>
               <td class="evenrowdata-l" width=28%>Create From Adapter Version</td>
               <TD class="evenrowdata-l">%value exportInfo/CREATE_IM_VER%</TD>
            </TR>
            <TR>
               <td class="evenrowdata-l" width=28%>Date Created</td>
               <TD class="evenrowdata-l">%value exportInfo/CREATE_DATE%</TD>
            </TR>
            <TR>
               <td class="evenrowdata-l" width=28%>Create From Oracle Applications Release</td>
               <TD class="evenrowdata-l">%value exportInfo/OA_RELEASE%</TD>
            </TR>
            <TR>
               <td class="evenrowdata-l" width=28%>Description</td>
               <TD class="evenrowdata-l">%value exportInfo/DESCRIPTION%</TD>
            </TR>
            
            <TR>
            <Td class="evenrowdata-l" width=28%>Import To Oracle Applications Release</td>
            %comment%
        ...
        <TABLE class="tableView" WIDTH=100%>
            <Tr >
                <Td class="heading" colspan=5>Choose Transactions to Import</Td>
            </TR>
            <TR class="subheading">
            	<td>Import this transaction <BR>
            	...
            	<td>Name</td>
            	<td width=15%>Transaction <BR>Type</td>
                <td>Import Name</td>
                <td width=20%>Overwrite <BR>Existing<BR>
            	    <INPUT type="button" value="Set" 
            ...
            %ifvar FILE_NO_TRANS%
                <TR>
                    <td id="message" colspan=5>No transactions found in file.</td>
                </TR>
