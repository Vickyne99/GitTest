...
<TABLE border=0 cellspacing=3 cellpadding=0 width=100%>
  <TR>
    <Td colspan=2 class="heading">%value ABOUT_LABEL% %value displayName%</Td></TR>
  <TR>
    <tr class="subheading3">
        <td colspan=5 > %value COPYRIGHT_LABEL%</td>
    </tr>
    %ifvar vendorName equals('webMethods, Inc.')%
    <script>writeTD('row');</script>
    <img src="/WmRoot/images/wmlogo.gif" border=0>
