...
<TR><td class="heading" colspan=8>Transaction Configuration</td></TR>
...
%ifvar fOARelease%
    ...
    %else%  
        ...
        <TR><td class="evenrowdata-l" width="28%">Transaction Type</td>
        ...
        <TR>
            <td class="heading" colspan=8>Current %ifvar transactionType equals('OUT')% Oracle-to-IS %else% IS-to-Oracle %endif%  Transactions</td>
        </TR>
