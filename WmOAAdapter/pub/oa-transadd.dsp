...
<TR><Td class="heading" colspan=2>New Transaction</Td></TR>
...
%endif%
	...
	<TR><Td class="subheading" colspan=2>Enter the new transaction name</Td></TR>

	<TR>
		<Td class="rowlabel" width="28%">Transaction Name</Td>
