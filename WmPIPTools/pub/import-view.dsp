<FORM NAME="importForm" ACTION="rn-import.dsp" METHOD="POST">
<INPUT TYPE="HIDDEN" NAME="action" VALUE="import">
<TABLE WIDTH="75%">
  %invoke wm.ip.rn.nextgen:previewPIP%
		%ifvar ArchiveInfo%
			<TR>
			    <TH COLSPAN=2 CLASS="title">Modular PIP Import File Details</TH>
			</TR>
			%loop ArchiveInfo%
				<TR> 
					...
					%ifvar manifest%
						%loop manifest%
							<TR><TD COLSPAN="2" CLASS="rowdata">
								%ifvar checkboxOn%
									<INPUT TYPE="CHECKBOX" NAME="file" VALUE="%value FileName%,%value Manifest_Message%" checked>
								%else%
									<INPUT TYPE="HIDDEN" NAME="file" VALUE="%value FileName%,%value Manifest_Message%">									
								%endif%
