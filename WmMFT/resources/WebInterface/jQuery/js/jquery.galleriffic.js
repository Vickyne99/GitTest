			...
			previewMedia: function(content, _fileName, ext, dim)
			{
				...
				function showPreview()
                {
                    setTimeout(function(){
                        ...
                        var path = "/WebInterface/function/?command=download&random="+rndm+"&mimeType="+mimeType + "&CrushAuth=" + $.cookie("CrushAuth")+"&path="+decodeURIComponent(_fileName).replace(/\&/g, "%26");
                        ...
                        else if(ext == "mp3")
                        {
                            if(window.useHTML5PlayerWhenAvailable && !!document.createElement('audio').canPlayType && !!document.createElement('audio').canPlayType("audio/mp3"))
                            {
                                ...
                                mPlayer.find("a").click(function(){
                                    var _path = "/WebInterface/function/?command=download&random="+rndm+"&mimeType="+mimeType + "&CrushAuth=" + $.cookie("CrushAuth")+"&path="+decodeURIComponent(_fileName).replace(/\&/g, "%26");
