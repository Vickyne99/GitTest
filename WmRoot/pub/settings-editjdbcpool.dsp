            ...
            <TR>
              ...
              %else%
                ...
                %else%
                    ...
                    %else%
                      <TEXTAREA name="spyParms" type="text" disabled STYLE="background-color: #CCCCCC;" cols="60" rows="1">%ifvar pool.spyParms -isnull%%value defaultSpyParms encode(html)%%else%%value pool.spyParm encode(html)s% %endif%</TEXTAREA></TD>
                    %endif%
                  %endif%
             %endif%
            </TR>
