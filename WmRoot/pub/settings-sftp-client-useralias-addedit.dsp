                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            %ifvar operation equals('edit')%
                                                                ...
                                                                <script>populateOptions('%value preferredKeyExchangeAlgorithm encode(javascript)%');</script>
                                                            %endif%
                                                        </td>
                                                        <td align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="oddrow-l" width="70%">
                                                ...
                                                %ifvar operation equals('edit')%
                                                    ...
                                                    <script>setSelection('proxyAlias',"%value proxyAlias encode(javascript)%");</script>
                                                %endif%
